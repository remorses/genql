...
user_by_pk:(user|null),__typename:'query_root'}
...
export interface user{age:Int,id:String,name:String,__typename:'user'}


/** aggregated selection of "user" */
export interface user_aggregate{aggregate:(user_aggregate_fields|null),nodes:user[],__typename:'user_aggregate'}


/** aggregate fields of "user" */
export interface user_aggregate_fields{avg:(user_avg_fields|null),count:(Int|null),max:(user_max_fields|null),min:(user_min_fields|null),stddev:(user_stddev_fields|null),stddev_pop:(user_stddev_pop_fields|null),stddev_samp:(user_stddev_samp_fields|null),sum:(user_sum_fields|null),var_pop:(user_var_pop_fields|null),var_samp:(user_var_samp_fields|null),variance:(user_variance_fields|null),__typename:'user_aggregate_fields'}


/** aggregate avg on columns */
export interface user_avg_fields{age:(Float|null),__typename:'user_avg_fields'}
...
export interface user_max_fields{age:(Int|null),id:(String|null),name:(String|null),__typename:'user_max_fields'}


/** aggregate min on columns */
export interface user_min_fields{age:(Int|null),id:(String|null),name:(String|null),__typename:'user_min_fields'}


/** aggregate stddev on columns */
export interface user_stddev_fields{age:(Float|null),__typename:'user_stddev_fields'}


/** aggregate stddev_pop on columns */
export interface user_stddev_pop_fields{age:(Float|null),__typename:'user_stddev_pop_fields'}


/** aggregate stddev_samp on columns */
export interface user_stddev_samp_fields{age:(Float|null),__typename:'user_stddev_samp_fields'}


/** aggregate sum on columns */
export interface user_sum_fields{age:(Int|null),__typename:'user_sum_fields'}


/** aggregate var_pop on columns */
export interface user_var_pop_fields{age:(Float|null),__typename:'user_var_pop_fields'}


/** aggregate var_samp on columns */
export interface user_var_samp_fields{age:(Float|null),__typename:'user_var_samp_fields'}


/** aggregate variance on columns */
export interface user_variance_fields{age:(Float|null),__typename:'user_variance_fields'}
...
update_user_by_pk:(user|null),__typename:'mutation_root'}
...
returning:user[],__typename:'user_mutation_response'}
...
user_aggregate:user_aggregate,
/** fetch data from the table: "user" using primary key columns */
user_by_pk:(user|null),__typename:'subscription_root'}
