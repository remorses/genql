...
export interface Query{repository:(Repository|null),user:(User|null),__typename:'Query'}


/** The `String` scalar type represents textual data, represented as UTF-8 character sequences. The String type is most often used by GraphQL to represent free-form human-readable text. */
export type String=string

export interface Repository{createdAt:(String|null),forks:(ForkEdge|null),__typename:'Repository'}

export interface ForkEdge{cursor:(String|null),node:(Fork|null),__typename:'ForkEdge'}

export interface Fork{name:(String|null),__typename:'Fork'}

export interface User{name:(String|null),__typename:'User'}

export interface Subscription{user:(User|null),__typename:'Subscription'}
...
export interface UserRequest{name?:boolean|number,__typename?:boolean|number,__scalar?:boolean|number}
...
export interface UserPromiseChain{name:({get:(request?:boolean|number,defaultValue?:(String|null))=>Promise<(String|null)>})}

export interface UserObservableChain{name:({get:(request?:boolean|number,defaultValue?:(String|null))=>Observable<(String|null)>})}
