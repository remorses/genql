...
export interface QueryObservableChain {
    ...
    coordinates: PointObservableChain & {
        get: (
            request: PointRequest,
            defaultValue?: Point | null,
...
export interface RepositoryPromiseChain {
    ...
    forks: ForkConnectionPromiseChain & {
        get: (
            request: ForkConnectionRequest,
            defaultValue?: ForkConnection | null,
        ) => Promise<ForkConnection | null>
    }
}
...
export interface RepositoryObservableChain {
    ...
    forks: ForkConnectionObservableChain & {
        get: (
            request: ForkConnectionRequest,
            defaultValue?: ForkConnection | null,
        ) => Observable<ForkConnection | null>
    }
}
...
export interface ForkConnectionPromiseChain {
    edges: {
        get: (
            request: ForkEdgeRequest,
            defaultValue?: (ForkEdge | null)[] | null,
        ) => Promise<(ForkEdge | null)[] | null>
    }
}
...
export interface ForkEdgePromiseChain {
    cursor: {
        ...
        ) => Promise<Scalars['String'] | null>
    }
    node: ForkPromiseChain & {
        get: (
            request: ForkRequest,
            defaultValue?: Fork | null,
        ) => Promise<Fork | null>
    }
}
...
export interface ForkEdgeObservableChain {
    cursor: {
        get: (
            request?: boolean | number,
            defaultValue?: Scalars['String'] | null,
        ) => Observable<Scalars['String'] | null>
    }
    node: ForkObservableChain & {
        get: (
            request: ForkRequest,
            defaultValue?: Fork | null,
        ) => Observable<Fork | null>
    }
}
...
export interface GuestPromiseChain {
    anonymous: {
        get: (
            request?: boolean | number,
            defaultValue?: Scalars['Boolean'] | null,
        ) => Promise<Scalars['Boolean'] | null>
    }
    common: {
        get: (
            request?: boolean | number,
...
export interface GuestObservableChain {
    anonymous: {
        get: (
            request?: boolean | number,
            defaultValue?: Scalars['Boolean'] | null,
        ) => Observable<Scalars['Boolean'] | null>
    }
    common: {
        get: (
            request?: boolean | number,
