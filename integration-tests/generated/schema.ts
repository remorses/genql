...
/** Some description */
repository:((args:{name: Scalars['String'],owner?: (Scalars['String']|null)})=>RepositoryPromiseChain & {get:<R extends RepositoryRequest>(request: R, defaultValue?:Repository)=>Promise<Repository>}),user:(UserPromiseChain & {get:<R extends UserRequest>(request: R, defaultValue?:(User|null))=>Promise<(User|null)>}),account:({get:<R extends AccountRequest>(request: R, defaultValue?:(Account|null))=>Promise<(Account|null)>}),coordinates:(PointPromiseChain & {get:<R extends PointRequest>(request: R, defaultValue?:(Point|null))=>Promise<(Point|null)>})}

export interface QueryObservableChain{
/** Some description */
repository:((args:{name: Scalars['String'],owner?: (Scalars['String']|null)})=>RepositoryObservableChain & {get:<R extends RepositoryRequest>(request: R, defaultValue?:Repository)=>Observable<Repository>}),user:(UserObservableChain & {get:<R extends UserRequest>(request: R, defaultValue?:(User|null))=>Observable<(User|null)>}),account:({get:<R extends AccountRequest>(request: R, defaultValue?:(Account|null))=>Observable<(Account|null)>}),coordinates:(PointObservableChain & {get:<R extends PointRequest>(request: R, defaultValue?:(Point|null))=>Observable<(Point|null)>})}

export interface RepositoryPromiseChain{createdAt:({get:(request?:boolean|number,defaultValue?:Scalars['String'])=>Promise<Scalars['String']>}),forks:(ForkConnectionPromiseChain & {get:<R extends ForkConnectionRequest>(request: R, defaultValue?:(ForkConnection|null))=>Promise<(ForkConnection|null)>})}

export interface RepositoryObservableChain{createdAt:({get:(request?:boolean|number,defaultValue?:Scalars['String'])=>Observable<Scalars['String']>}),forks:(ForkConnectionObservableChain & {get:<R extends ForkConnectionRequest>(request: R, defaultValue?:(ForkConnection|null))=>Observable<(ForkConnection|null)>})}

export interface ForkConnectionPromiseChain{edges:({get:<R extends ForkEdgeRequest>(request: R, defaultValue?:((ForkEdge|null)[]|null))=>Promise<((ForkEdge|null)[]|null)>})}

export interface ForkConnectionObservableChain{edges:({get:<R extends ForkEdgeRequest>(request: R, defaultValue?:((ForkEdge|null)[]|null))=>Observable<((ForkEdge|null)[]|null)>})}

export interface ForkEdgePromiseChain{cursor:({get:(request?:boolean|number,defaultValue?:(Scalars['String']|null))=>Promise<(Scalars['String']|null)>}),node:(ForkPromiseChain & {get:<R extends ForkRequest>(request: R, defaultValue?:(Fork|null))=>Promise<(Fork|null)>})}

export interface ForkEdgeObservableChain{cursor:({get:(request?:boolean|number,defaultValue?:(Scalars['String']|null))=>Observable<(Scalars['String']|null)>}),node:(ForkObservableChain & {get:<R extends ForkRequest>(request: R, defaultValue?:(Fork|null))=>Observable<(Fork|null)>})}
...
export interface SubscriptionPromiseChain{user:(UserPromiseChain & {get:<R extends UserRequest>(request: R, defaultValue?:(User|null))=>Promise<(User|null)>})}

export interface SubscriptionObservableChain{user:(UserObservableChain & {get:<R extends UserRequest>(request: R, defaultValue?:(User|null))=>Observable<(User|null)>})}
...
export interface HousePromiseChain{owner:(UserPromiseChain & {get:<R extends UserRequest>(request: R, defaultValue?:(User|null))=>Promise<(User|null)>}),x:({get:(request?:boolean|number,defaultValue?:(Scalars['String']|null))=>Promise<(Scalars['String']|null)>}),y:({get:(request?:boolean|number,defaultValue?:(Scalars['String']|null))=>Promise<(Scalars['String']|null)>})}

export interface HouseObservableChain{owner:(UserObservableChain & {get:<R extends UserRequest>(request: R, defaultValue?:(User|null))=>Observable<(User|null)>}),x:({get:(request?:boolean|number,defaultValue?:(Scalars['String']|null))=>Observable<(Scalars['String']|null)>}),y:({get:(request?:boolean|number,defaultValue?:(Scalars['String']|null))=>Observable<(Scalars['String']|null)>})}
