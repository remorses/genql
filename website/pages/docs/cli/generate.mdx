...
The order of generated object properties is taken from the schema introspection, popular frameworks like apollo only change the order of the fields only when you change them in your graphql schema
