...
export interface QueryRequest {
    continents?: ContinentRequest
    continent?: [{ code: ID }, ContinentRequest]
    countries?:
        | [{ filter?: CountryFilterInput | null }, CountryRequest]
        | CountryRequest
    country?: [{ code: ID }, CountryRequest]
    languages?:
        | [{ filter?: LanguageFilterInput | null }, LanguageRequest]
        | LanguageRequest
...
export interface ContinentPromiseChain {
    code: {
        get: (request?: boolean | number, defaultValue?: ID) => Promise<ID>
    }
    name: {
        get: (
...
export interface ContinentObservableChain {
    code: {
        get: (request?: boolean | number, defaultValue?: ID) => Observable<ID>
    }
    name: {
        get: (
            request?: boolean | number,
