...
export const isuser_aggregate = (obj: {
    __typename: String
}): obj is user_aggregate => {
    if (!obj.__typename) throw new Error('__typename is missing')
...
export const isuser_stddev_pop_fields = (obj: {
    __typename: String
}): obj is user_stddev_pop_fields => {
    if (!obj.__typename) throw new Error('__typename is missing')
...
export const isuser_var_samp_fields = (obj: {
    __typename: String
}): obj is user_var_samp_fields => {
    if (!obj.__typename) throw new Error('__typename is missing')
...
export const isuser_variance_fields = (obj: {
    __typename: String
}): obj is user_variance_fields => {
    if (!obj.__typename) throw new Error('__typename is missing')
...
export const isuser_mutation_response = (obj: {
    __typename: String
}): obj is user_mutation_response => {
    if (!obj.__typename) throw new Error('__typename is missing')
...
export interface query_rootPromiseChain {
    ...
    user_aggregate: ((args?: {
        ...
        get: <R extends user_aggregateRequest>(
            request: R,
            defaultValue?: user_aggregate,
        ) => Promise<user_aggregate>
    }) &
        (user_aggregatePromiseChain & {
            get: <R extends user_aggregateRequest>(
                request: R,
...
export interface userPromiseChain {
    age: {
        get: (request?: boolean | number, defaultValue?: Int) => Promise<Int>
    }
    id: {
        get: (
...
export interface userObservableChain {
    age: {
        get: (request?: boolean | number, defaultValue?: Int) => Observable<Int>
    }
    id: {
        get: (
            request?: boolean | number,
...
export interface user_aggregatePromiseChain {
    aggregate: user_aggregate_fieldsPromiseChain & {
        get: <R extends user_aggregate_fieldsRequest>(
            request: R,
            defaultValue?: FieldsSelection<user_aggregate_fields, R> | null,
        ) => Promise<FieldsSelection<user_aggregate_fields, R> | null>
    }
    nodes: {
        get: <R extends userRequest>(
            request: R,
...
export interface user_aggregateObservableChain {
    aggregate: user_aggregate_fieldsObservableChain & {
        get: <R extends user_aggregate_fieldsRequest>(
            request: R,
            defaultValue?: FieldsSelection<user_aggregate_fields, R> | null,
        ) => Observable<FieldsSelection<user_aggregate_fields, R> | null>
    }
    nodes: {
        get: <R extends userRequest>(
            request: R,
...
export interface user_aggregate_fieldsPromiseChain {
    avg: user_avg_fieldsPromiseChain & {
        get: <R extends user_avg_fieldsRequest>(
            request: R,
            defaultValue?: FieldsSelection<user_avg_fields, R> | null,
        ) => Promise<FieldsSelection<user_avg_fields, R> | null>
    }
    count: ((args?: {
        columns?: user_select_column[] | null
    ...
    max: user_max_fieldsPromiseChain & {
        get: <R extends user_max_fieldsRequest>(
            request: R,
            defaultValue?: FieldsSelection<user_max_fields, R> | null,
        ) => Promise<FieldsSelection<user_max_fields, R> | null>
    }
    min: user_min_fieldsPromiseChain & {
        get: <R extends user_min_fieldsRequest>(
            request: R,
            defaultValue?: FieldsSelection<user_min_fields, R> | null,
        ) => Promise<FieldsSelection<user_min_fields, R> | null>
    }
    stddev: user_stddev_fieldsPromiseChain & {
        get: <R extends user_stddev_fieldsRequest>(
            request: R,
            defaultValue?: FieldsSelection<user_stddev_fields, R> | null,
        ) => Promise<FieldsSelection<user_stddev_fields, R> | null>
    }
    stddev_pop: user_stddev_pop_fieldsPromiseChain & {
        get: <R extends user_stddev_pop_fieldsRequest>(
            request: R,
            defaultValue?: FieldsSelection<user_stddev_pop_fields, R> | null,
        ) => Promise<FieldsSelection<user_stddev_pop_fields, R> | null>
    }
    stddev_samp: user_stddev_samp_fieldsPromiseChain & {
        get: <R extends user_stddev_samp_fieldsRequest>(
            request: R,
            defaultValue?: FieldsSelection<user_stddev_samp_fields, R> | null,
        ) => Promise<FieldsSelection<user_stddev_samp_fields, R> | null>
    }
    sum: user_sum_fieldsPromiseChain & {
        get: <R extends user_sum_fieldsRequest>(
            request: R,
            defaultValue?: FieldsSelection<user_sum_fields, R> | null,
        ) => Promise<FieldsSelection<user_sum_fields, R> | null>
    }
    var_pop: user_var_pop_fieldsPromiseChain & {
        get: <R extends user_var_pop_fieldsRequest>(
            request: R,
            defaultValue?: FieldsSelection<user_var_pop_fields, R> | null,
        ) => Promise<FieldsSelection<user_var_pop_fields, R> | null>
    }
    var_samp: user_var_samp_fieldsPromiseChain & {
        get: <R extends user_var_samp_fieldsRequest>(
            request: R,
            defaultValue?: FieldsSelection<user_var_samp_fields, R> | null,
        ) => Promise<FieldsSelection<user_var_samp_fields, R> | null>
    }
    variance: user_variance_fieldsPromiseChain & {
        get: <R extends user_variance_fieldsRequest>(
            request: R,
            defaultValue?: FieldsSelection<user_variance_fields, R> | null,
        ) => Promise<FieldsSelection<user_variance_fields, R> | null>
    }
}
...
export interface user_aggregate_fieldsObservableChain {
    avg: user_avg_fieldsObservableChain & {
        get: <R extends user_avg_fieldsRequest>(
            request: R,
            defaultValue?: FieldsSelection<user_avg_fields, R> | null,
        ) => Observable<FieldsSelection<user_avg_fields, R> | null>
    }
    count: ((args?: {
        columns?: user_select_column[] | null
        distinct?: Boolean | null
    ...
    max: user_max_fieldsObservableChain & {
        get: <R extends user_max_fieldsRequest>(
            request: R,
            defaultValue?: FieldsSelection<user_max_fields, R> | null,
        ) => Observable<FieldsSelection<user_max_fields, R> | null>
    }
    min: user_min_fieldsObservableChain & {
        get: <R extends user_min_fieldsRequest>(
            request: R,
            defaultValue?: FieldsSelection<user_min_fields, R> | null,
        ) => Observable<FieldsSelection<user_min_fields, R> | null>
    }
    stddev: user_stddev_fieldsObservableChain & {
        get: <R extends user_stddev_fieldsRequest>(
            request: R,
            defaultValue?: FieldsSelection<user_stddev_fields, R> | null,
        ) => Observable<FieldsSelection<user_stddev_fields, R> | null>
    }
    stddev_pop: user_stddev_pop_fieldsObservableChain & {
        get: <R extends user_stddev_pop_fieldsRequest>(
            request: R,
            defaultValue?: FieldsSelection<user_stddev_pop_fields, R> | null,
        ) => Observable<FieldsSelection<user_stddev_pop_fields, R> | null>
    }
    stddev_samp: user_stddev_samp_fieldsObservableChain & {
        get: <R extends user_stddev_samp_fieldsRequest>(
            request: R,
            defaultValue?: FieldsSelection<user_stddev_samp_fields, R> | null,
        ) => Observable<FieldsSelection<user_stddev_samp_fields, R> | null>
    }
    sum: user_sum_fieldsObservableChain & {
        get: <R extends user_sum_fieldsRequest>(
            request: R,
            defaultValue?: FieldsSelection<user_sum_fields, R> | null,
        ) => Observable<FieldsSelection<user_sum_fields, R> | null>
    }
    var_pop: user_var_pop_fieldsObservableChain & {
        get: <R extends user_var_pop_fieldsRequest>(
            request: R,
            defaultValue?: FieldsSelection<user_var_pop_fields, R> | null,
        ) => Observable<FieldsSelection<user_var_pop_fields, R> | null>
    }
    var_samp: user_var_samp_fieldsObservableChain & {
        get: <R extends user_var_samp_fieldsRequest>(
            request: R,
            defaultValue?: FieldsSelection<user_var_samp_fields, R> | null,
        ) => Observable<FieldsSelection<user_var_samp_fields, R> | null>
    }
    variance: user_variance_fieldsObservableChain & {
        get: <R extends user_variance_fieldsRequest>(
            request: R,
            defaultValue?: FieldsSelection<user_variance_fields, R> | null,
        ) => Observable<FieldsSelection<user_variance_fields, R> | null>
    }
}
...
export interface mutation_rootPromiseChain {
    ...
    delete_user: (args: {
        ...
        get: <R extends user_mutation_responseRequest>(
            request: R,
            defaultValue?: FieldsSelection<user_mutation_response, R> | null,
        ) => Promise<FieldsSelection<user_mutation_response, R> | null>
    }
    /** delete single row from the table: "user" */
...
export interface mutation_rootObservableChain {
    ...
    delete_user: (args: {
        ...
        get: <R extends user_mutation_responseRequest>(
            request: R,
            defaultValue?: FieldsSelection<user_mutation_response, R> | null,
        ) => Observable<FieldsSelection<user_mutation_response, R> | null>
    }
    /** delete single row from the table: "user" */
    delete_user_by_pk: (args: {
        id: String
